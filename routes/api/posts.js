...
router.post("/", async (req, res, next) => {
  ...
  Post.create(postData)
    .then(async (newPost) => {
      ...
      // It populates the postedBy field, meaning it replaces the user ID with the actual user details from the User schema.
      // this line of code  populates the postedBy field in the DB
      //  it is gonna do so using "User" schema
